...
const maleServices = [
  {
    name: "Men's Haircut",
    price: "₹300",
    description: "A classic haircut for men, tailored to your preferences.",
  },
  {
    name: "Men's Manicure",
    price: "₹200",
    description: "Groom your nails with our professional manicure services.",
  },
  {
    name: "Men's Pedicure",
    price: "₹250",
    description: "Relax and pamper your feet with our pedicure treatment.",
  },
  {
    name: "Beard Trim",
    price: "₹150",
    description: "Get your beard shaped and styled to perfection.",
  },
  {
...
const femaleServices = [
  {
    ...
    price: "₹350",
    description:
      "Transform your look with a stylish haircut designed for women.",
  },
  {
    name: "Women's Manicure",
    price: "₹250",
    description:
      "Indulge in our manicure services to keep your nails looking fabulous.",
  },
  {
    name: "Women's Pedicure",
    price: "₹300",
    description:
      "Treat your feet to a relaxing pedicure session for soft and smooth skin.",
  },
  {
    name: "Hair Coloring",
    price: "₹400",
    description:
      "Add a pop of color to your hair with our professional hair coloring service.",
  },
  {
    name: "Hair Styling",
    price: "₹300",
    description:
      "Let our experts style your hair for any occasion, from casual to glamorous.",
  },
